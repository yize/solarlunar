 ...
 * @Time  2014-7-21
 * @Version  $ID$
 * @公历转农历：solarLunar.solar2lunar(1987,11,01); 
 * @农历转公历：solarLunar.lunar2solar(1987,09,10); 
 * @link http:
 */
const solarLunar = {
  lunarInfo,
   ...
   * @param lunar Year
   * @return Number
   * @eg:var count = solarLunar.lYearDays(1987) ;
   */
   ...
   * @param lunar Year
   * @return Number (0-12)
   * @eg:var leapMonth = solarLunar.leapMonth(1987) ;
   */
   ...
   * @eg:var leapMonthDay = solarLunar.leapDays(1987) ;
   */
  leapDays: function (y) {
   ...
   * @eg:var MonthDay = solarLunar.monthDays(1987,9) ;
   */
   ...
   * @eg:var solarMonthDay = solarLunar.leapDays(1987) ;
   */
   ...
   * @eg:var _24 = solarLunar.getTerm(1987,3) ;
   */
   ...
   * @eg:var cnMonth = solarLunar.toChinaMonth(12) ;
   */
   ...
   * @param lunar day
   * @return Cn string
   * @eg:var cnDay = solarLunar.toChinaDay(21) ;
   */
   ...
   * @return Cn string
   * @eg:var animal = solarLunar.getAnimal(1987) ;
   */
